...
public final class FindMeetingQueryTest {
  ...
  @Test
  public void everyAttendeeIsConsideredOptionalAttendeeUnavailable() {
    // Optional attendee C has a whole day event. We should see three options and C is not invited.
    //
    // Events  :       |--A--|     |--B--|
    //           |--------------C--------------|
    // Day     : |-----------------------------|
  ...
  @Test
  public void everyAttendeeIsConsideredOptionalAttendeeInvited() {
    // Optional attendee C is available and should be considered.
    //
    // Events  :       |--A--|--C--|--B--|
    // Day     : |-----------------------------|
    // Options : |--1--|                 |--3--|
  ...
  @Test
  public void justEnoughRoomIgnoresOptionalAttendee() {
    // One mandatory attendee A with just enough room at one point in the day to have the meeting; 
    // optional attendee B should be ignored.
    //
    // Events  : |--A--|-B|  |----A----|
    // Day     : |---------------------|
    // Options :       |-----|
  ...
  @Test
  public void justTwoOptionalAttendees() {
  ...
  @Test
  public void justTwoOptionalAttendeesUnavailable() {
  ...
  @Test
  public void maximumNumberOfOptionalAttendees() {
    // One mandatory attendee A, three optional attendees where either B can fit or C and D can both fit.
    //
    // Events  :     |--A--|
    //                   |-----B-------|
    //           |---C---|
